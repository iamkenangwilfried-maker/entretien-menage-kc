        ...
        >
          {items.map((item, i) => {
            ...
            return (
              ...
              >
                <div className="relative w-full h-full rounded-2xl shadow-2xl overflow-hidden border border-card-border">
                  <img
                    src={item.photo.url}
                    alt={item.photo.alt}
                  ...
                  />
                  <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-navy/90 via-navy/50 to-transparent text-white">
